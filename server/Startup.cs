...
namespace B
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlite(Configuration.GetConnectionString("b1Connection"));
            ...
            services.AddScoped<B1Service>();

            services.AddDbContext<B.Data.B1Context>(options =>
            {
              options.UseSqlite(Configuration.GetConnectionString("b1Connection"));
            });
